...
<body>
			...
			<div class="panel-body">
				<table>
					<tr>
						<td><b>ProductName</b>: ${product.productname }<br> <b>Category
						...
						</b>: ${product.price }<br> <b>Quantity </b>:${product.quantity }<br><br>
							<security:authorize access="hasRole('ROLE_USER')">
								...
								<h3><a href="<c:url value='/cart/addtocart/${product.id}?requestedQuantity=1'></c:url>" >Add to Cart</a></h3> 
	...
	<h4><a href='<c:url value="/all/getproducts"></c:url>'> Back</a></h4>
</body>
</html>
