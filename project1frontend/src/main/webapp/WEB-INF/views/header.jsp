	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href=""><img
				src='<c:url value="/resources/images/logoedited.jpg"></c:url>'
		...
		<div class="collapse navbar-collapse" id="collapse-example">
			...
			<li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown">Select by Category<b class="caret"></b></a>
				<ul class="dropdown-menu" role="menubar">
					<li>
						<a href='<c:url value="/all/searchbycategory?searchCondition=Vivo"></c:url>'>Vivo</a>
						<a href='<c:url value="/all/searchbycategory?searchCondition=Oppo"></c:url>'>Oppo</a>		
						<a href='<c:url value="/all/searchbycategory?searchCondition=HTC"></c:url>'>HTC</a>					
					</li>
				</ul>
			</li>
